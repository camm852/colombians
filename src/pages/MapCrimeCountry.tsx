...
const Profile = () => {
    ...
    return (
        <>
            <Breadcrumb pageName="Detenidos Por País"/>
            <div
                ...
                <MapContainer center={[51.505, -0.09]} zoom={3} scrollWheelZoom={false}>
                    ...
                    {data.map(actualD => (
                        <Marker position={[actualD.latitud,actualD.longitud]}>
                            <Popup>
                                <h4><b>País</b> : {actualD.pais_prisi_n}</h4>
                                <p><b>Número de detenidos</b> : {countries[actualD.pais_prisi_n]}</p>
                                <p><b>Latitud</b> : {actualD.latitud}</p>
                                <p><b>Longitud</b> : {actualD.longitud}</p>
                            </Popup>
                        </Marker>
                    ))}
                </MapContainer>
